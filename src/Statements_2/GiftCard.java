        ...
        switch (item){
            case "Blanket":
                result = "Thank you for your purchase!";
                     result2= "Your current balance is: " + (giftCard - 60) + "$";
                break;
            case "Charger": case "Hat":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 25) + "$";
                break;
            case "Headphones":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 30) + "$";
                break;
            ...
            case "Pants":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 50) + "$";
                break;
            case "Pillow":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 40) + "$";
                break;
            case "Socks":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 10) + "$";
                break;
            case "USB cable":
                result = "Thank you for your purchase!";
                result2 = "Your current balance is: " + (giftCard - 5) + "$";
                break;
            default:
                result = "Invalid item!";
